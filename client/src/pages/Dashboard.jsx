  ...
  return (
    <div className='min-h-screen'>
        ...
        <div className='shadow py-4'>
            <div className='px-5 flex justify-between items-center'>
                ...
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden'>Welcome, Khaleed</p>
                    <div className='relative group'>
                        <img className='w-8 border-2 border-blue-300 rounded-full' src={assets.company_icon} alt="" />
                        <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                            <ul className='list-none m-0 p-2 bg-white rounded-md border-[#e5e7eb] text-sm'>
        ...
        <div className='flex items-start'>
            ...
            <div className='inline-block min-h-screen border-r-2 border-[#e5e7eb]'>
